  ...
  return (
    <>
      <div className={`${className} desktop-image`}>
        <NetlifyImage src={`/images/${desktopFile}`} alt={alt} sizes="100vw" />
        <SavingsBadge file={desktopFile} />
      </div>
      <div className={`${className} mobile-image`}>
        <NetlifyImage src={`/images/${mobileFile}`} alt={alt} sizes="100vw" />
        <SavingsBadge file={mobileFile} />
      </div>
    </>
  );
}
      ...
      <header>
        <div className="header-inner">
          <div className="nav-left">
            <a className="logo" href="/" aria-label="Vuori home">
              <NetlifyImage src="/images/vuori_gradient_logo.png" alt="Vuori" width={130} height={28} priority />
            </a>
            <nav>
      ...
      <section className="sub-hero">
        <div className="sub-hero-item">
          <div className="fill-image">
            ...
            />
            <SavingsBadge file="0316_sp26_homepage_sub_metacotton_desktop.png" />
          </div>
        ...
        <div className="sub-hero-item">
          <div className="fill-image">
            <NetlifyImage
              ...
              sizes="(max-width: 768px) 100vw, 50vw"
            />
            <SavingsBadge file="0316_sp26_homepage_sub_w_denim_desktop.png" />
          </div>
          <div className="sub-hero-overlay">
          ...
          {newArrivals.map((product) => (
            <div className="product-card" key={product.file}>
              <div className="product-img-wrap">
                ...
                />
                <SavingsBadge file={product.file} />
              </div>
        ...
        <div className="footer-inner">
          <div className="footer-top">
            <div className="footer-brand">
              <div className="logo">
                <NetlifyImage src="/images/vuori_gradient_logo.png" alt="Vuori" width={112} height={24} />
              </div>
